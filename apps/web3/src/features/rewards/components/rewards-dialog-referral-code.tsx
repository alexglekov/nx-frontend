...
import { MUTATION_UPDATE_USER_REFFERAL } from 'api/rewards/mutation-update-user-refferal'
...
import { RefferalCodeForm } from '../types'
...
export const ChangeRefferalCodeModal: React.FC = () => {
  ...
  const { refetchRefferalCode } = useInviteFriendsInfo()

  const [commitUpdateRefferal, { loading }] = useMutation(
    MUTATION_UPDATE_USER_REFFERAL
  )
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    const mutationOptions = {
      variables: { data: { code: formValues.code } },

...
export const UserSettingsMainItems: React.FC<Props> = ({ user }) => {
  return (
    ...
    >
      ...
      <UserSettingsMainItem
        name={MAIN_SETTINGS.EMAIL.name}
        value={user?.email || ''}
        buttonText={MAIN_SETTINGS.EMAIL.buttonText}
        dataTestID={MAIN_SETTINGS.EMAIL.dataTestIdLocator}
      />
      ...
      <UserSettingsMainItem
        name={MAIN_SETTINGS.PASSWORD.name}
        value={'********'}
        buttonText={MAIN_SETTINGS.PASSWORD.buttonText}
        dataTestID={MAIN_SETTINGS.PASSWORD.dataTestIdLocator}
      />

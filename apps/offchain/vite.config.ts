...
// TODO: complete extraction of web3 heavy packages from the vendor chunk
function isWeb3Dependency(id: string) {
  return false
  // return id.includes('@thirdweb-dev') || id.includes('@eth-optimism')
  // id.includes('@account-abstraction') ||

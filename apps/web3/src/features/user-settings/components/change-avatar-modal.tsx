    ...
    <XyroDialog
      ...
      dialogTrigger={
        <Button
          ...
          data-testid={userSettingsAvatar}
        >
          {userAvatarPath ?
            <XyroAvatar
              displayLevel={false}
        ...
        >
          {step === CROPPER_STEP && cropperPreview === userAvatarPath ?
            <IconButton
              ...
              data-testid={userSettingsDeleteAvatar}
            >
              {!deleteAvatarLoading ?
                <TrashIcon />
              : <XyroLoadingSpinner />}
          ...
          {step === DND_STEP && !userAvatarPath ?
            ...
            <Flex data-testid={userSettingsUploadAvatarArea}>
              <FileUploader
            ...
            {cropperPreview !== userAvatarPath ?
              <RadixForm.Submit asChild>
                <Button
                  ...
                  data-testid={buttonUserSettingsUploadAvatar}
                >
...
const {
  userSettingsUploadAvatarArea,
  buttonUserSettingsUploadAvatar,
  userSettingsAvatar,
  userSettingsDeleteAvatar
} = DataTestIDs
